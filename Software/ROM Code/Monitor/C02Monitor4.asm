;**************************************************************************************************
;*   C02Monitor 4.02 - Release version for Pocket SBC  (c)2013-2023 by Kevin E. Maier 15/02/2023  *
;*                                                                                                *
...
;**************************************************************************************************
;
; Note: No code changes, just updated version and date to mimic the recent BIOS changes/updates.
;
; The Assembler is not yet implemented.... but there is some initial development code included.
; - this does some pre-processing and then JUMPs to $0800 to the current development code.
; - Needless to say, don't get excited thinking it works... sorry ;-)
;
...
CHNG_LP         LDA     INDEXH          ;Test high byte address for RAM (less than $80)
                CMP     #$E0            ;Check for Start of ROM at $E000
                BCS     NO_RAM          ;Address is in ROM, can not edit.
...
;
; A quick cheat: just load 20 blocks from the offset into high memory and cold start SIM
;
BOOT_MICRODRIVE
...
;
                LDA     #$00            ;Set Address low byte
                LDY     #$B8            ;Set Address high byte
                LDX     #20             ;Set Block count to 20 (10KB)
...
MONTAB  .DW     ASSEMBLER       ;[CNTRL-A] $01 Start Assembler
        .DW     BOOT_MICRODRIVE ;[CNTRL-B] $02 Boot from Microdrive
...
MSG_49  .DB     $0D,$0A
        ...
        .DB     $00
MSG_4A  .DB     "Error reading Microdrive!",$0A,$0D
        .DB     $00
MSG_4B  .DB     "Partition Record is invalid!",$0A,$0D
        .DB     #$00
;
MSG_TABLE       ;Message table: contains message addresses sent via the PROMPT routine
        ...
        .DW     MSG_48, MSG_49, MSG_4A, MSG_4B
;
part_offset
